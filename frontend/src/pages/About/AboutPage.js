        ...
        <div className="right_about">
          <section className="point_about">
            ...
            <div className="content_about">
              <ul>
                <li>
                  鼓励大家在对应话题下分享你的想法，你的每一次表达没准就可以让与你相似的他们发现你并结识。
                </li>
                <li>
                  通过匿名的方式，没人知道你是谁，你可以无压力的诉说实名不敢讲、不想讲的心事。
                </li>
                <li>
                  每一个留学在外的灵魂都值得被治愈，和陌生人温暖相遇后，别忘记传递更多的温暖。么么相信，每一个灵魂都能得到温暖回应；你的一句回复，便会拯救一个“孤独”的灵魂。
                </li>
              </ul>
            </div>
          </section>
          <section className="point_about">
            <div className="title_about"> 么么提醒 </div>
            <div className="content_about">
              <p>
          ...
          <section className="point_about">
            <div className="title_about"> 么么拒绝 </div>
            <div className="content_about">
              <p>
          ...
          <section className="point_about">
            <div className="title_about"> 么么提倡 </div>
            <div className="content_about">
              <p>
                对于社交平台上的发言，如果以截图（Image
                Post）的形式转载，公众人物和机构的发言可以直接转发，但非公众人物（没有加
                V 的普通网友或小范围的网红）的发言，其帖文和评论中的所有 ID
                都需要打码处理。不要以「奇文共赏」、「欢乐群嘲」为目的恶意转发其他社区的评论。
              </p>
            </div>
          </section>
          <section className="point_about">
            <div className="title_about"> 么么希望 </div>
            <div className="content_about">
              <p>
